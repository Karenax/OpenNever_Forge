...
const topics: GuideTopic[] = [
  ...
  },
  {
    ...
    summary: "Trouver une réplique et modifier sa branche sans afficher mille nœuds à la fois.",
    icon: ScrollText,
    prerequisites: ["Le module est analysé.", "L’atelier transactionnel est requis pour enregistrer."],
    steps: [
      { title: "Trouver le DLG", instruction: "Ouvrez Dialogues et utilisez le filtre global pour réduire la liste. Sélectionnez le ResRef voulu dans la colonne gauche.", expected: "Le graphe s’ouvre au centre avec ses compteurs de nœuds, liens et cycles." },
      { title: "Rechercher la réplique", instruction: "Dans la barre du graphe, saisissez une phrase, un locuteur, un commentaire ou un identifiant. La vue se recentre sur les correspondances et leur voisinage.", control: "Rechercher un nœud de dialogue", expected: "Le compteur indique combien de nœuds sont affichés sur le total sans zoom microscopique." },
      { title: "Explorer la branche", instruction: "Cliquez un nœud pour le sélectionner et le recentrer. Réglez Voisinage de 1 à 4 niveaux ; utilisez Arbre simplifié pour déplier une branche à la demande.", expected: "Le nœud, ses liens et ses propriétés restent lisibles." },
      { title: "Modifier et relier", instruction: "Éditez le texte ou les scripts dans l’inspecteur du dialogue. Pour ajouter un lien, reliez deux nœuds sur le graphe ou utilisez Ajouter un lien sortant.", expected: "La structure est enregistrée dans l’overlay et le graphe se recharge sans lien cassé." },
    ],
